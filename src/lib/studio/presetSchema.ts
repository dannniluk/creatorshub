...
export const studioPresetSchema = z.object({
  ...
  promptTemplateCompact: z.string().min(20),
  promptTemplateFull: z.string().min(20),
...
export const STUDIO_PRESET_JSON_SCHEMA = {
  ...
  properties: {
    ...
    promptTemplateCompact: { type: "string", minLength: 20 },
    promptTemplateFull: { type: "string", minLength: 20 },
    locks: {
      type: "object",
